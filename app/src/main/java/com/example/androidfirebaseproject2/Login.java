...
import com.example.androidfirebaseproject2.R;
import com.example.androidfirebaseproject2.Register;
                ...
                if(!TextUtils.isEmpty(loginEmail) || !TextUtils.isEmpty(loginSenha)){
                    ...
                    mAuth.signInWithEmailAndPassword(loginEmail, loginSenha).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        private void abrirTelaPrincipal() {
                            Intent intent = new Intent(Login.this, com.example.androidfirebaseproject2.MainActivity.class);
